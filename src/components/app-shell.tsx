...
export function AppShell({children}:{children:React.ReactNode}) {
  ...
  return <main className="min-h-screen bg-[#f7f7f5] text-[#161616]">
    <header className="border-b border-black/10 bg-white"><nav className="mx-auto flex max-w-6xl flex-wrap items-center gap-5 px-6 py-5 text-sm">
      <Link className="mr-auto text-xl font-bold" href="/">CodeDuel<span className="text-[#ed5b39]">.</span></Link>
      <Link href="/practice">Practice</Link><Link href="/onboarding/placement">Placements</Link><Link href="/queue">Ranked</Link>
