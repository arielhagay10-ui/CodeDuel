...
function PlacementChallengeContent() {
  ...
  return (
    <main className="min-h-screen bg-[#f7f7f5] text-[#161616]">
      <header className="border-b border-black/10 bg-white"><div className="mx-auto flex h-16 max-w-[1440px] items-center justify-between px-5 sm:px-8"><Link href="/onboarding/placement" className="text-xl font-bold tracking-[-0.06em]">CodeDuel<span className="text-[#ed5b39]">.</span></Link><div className="flex items-center gap-4"><span className="text-xs font-bold uppercase tracking-[0.14em] text-black/45">{level} · placement {round}/5</span><span className="font-mono text-lg font-semibold">{timerLabel}</span></div></div></header>
