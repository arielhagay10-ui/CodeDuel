...
export default function PlacementPage() {
  ...
  return (
    <main className="min-h-screen bg-[#f7f7f5] px-5 py-8 text-[#161616] sm:px-8 sm:py-12">
      <header className="mx-auto flex max-w-4xl items-center justify-between"><Link href="/" className="text-xl font-bold tracking-[-0.06em]">CodeDuel<span className="text-[#ed5b39]">.</span></Link><p className="text-xs font-bold uppercase tracking-[0.16em] text-black/40">Step 3 of 3</p></header>
