  ...
  return (
    <main className="grid min-h-screen place-items-center bg-[#f7f7f5] p-5 text-[#161616]">
      <section className="w-full max-w-2xl overflow-hidden rounded-2xl border border-black/10 bg-white shadow-[0_20px_60px_rgb(0_0_0_/_0.08)]">
        <div className="bg-[#161616] px-7 py-8 text-white sm:px-10"><Link href="/" className="text-xl font-bold tracking-[-0.06em]">CodeDuel<span className="text-[#ed5b39]">.</span></Link><p className="mt-10 text-xs font-bold uppercase tracking-[0.18em] text-[#ed5b39]">Placement complete</p><h1 className="mt-3 text-4xl font-semibold tracking-[-0.055em]">You are ready to rank.</h1></div>
